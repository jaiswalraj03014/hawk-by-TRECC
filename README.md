...
| --- | --- | --- | --- |
| <img src="https://www.google.com/s2/favicons?sz=64&domain=0g.ai" width="24" alt="0G logo" /> | **0G** | Proof-of-Intent memory layer for storing agent decisions before execution. | [0g.ai](https://0g.ai/) |
| <img src="https://cdn.simpleicons.org/uniswap/FF007A" width="24" alt="Uniswap logo" /> | **Uniswap** | Primary WETH/USDC quote source through the Uniswap Trading API; core strategy code also includes Uniswap V3 pool state reads. | [API docs](https://api-docs.uniswap.org/) |
